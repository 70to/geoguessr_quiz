                ...
                <div className="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    <div className="sm:fixed inset-0 z-10 overflow-y-auto">
                        <div
                            ...
                            <div
                                className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:px-6 sm:py-10">
                                <BrowserRouter>
                                    {!state.startFlag && (
                                        <QuizList/>
                                    )}
